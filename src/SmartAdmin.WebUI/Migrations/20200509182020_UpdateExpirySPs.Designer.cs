...
namespace SmartAdmin.WebUI.Migrations
{
    ...
    [Migration("20200509182020_UpdateExpirySPs")]
    partial class UpdateExpirySPs
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmartAdmin.WebUI.UnitRentContractPayment", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("SmartAdmin.WebUI.UnitRentContractPayment", b =>
                {
                    b.HasOne("SmartAdmin.WebUI.UnitRentContract", "UnitRentContract")
                        .WithMany("UnitRentContractPayments")
                        .HasForeignKey("UnitRentContractID")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("SmartAdmin.WebUI.ApplicationUser", "User")
                        .WithMany()
