...
{
    public class NumberToTextLogic
    {
        ...
        /// Currency to use
        /// </summary>
        public CurrencyInfoLogic Currency { get; set; }
        ...
        #region General
        public NumberToTextLogic(CurrencyInfoLogic currency)
            : this(0, currency)
        {
        ...
        public NumberToTextLogic(Decimal number, CurrencyInfoLogic currency)
        {
        ...
        public NumberToTextLogic(Decimal number, CurrencyInfoLogic currency, String englishPrefixText, String englishSuffixText, String arabicPrefixText, String arabicSuffixText)
        {
        ...
        /// <param name="arabicPrefixText">Arabic text to be placed before the generated text</param>
        /// <param name="arabicSuffixText">Arabic text to be placed after the generated text</param>
        private void InitializeClass(Decimal number, CurrencyInfoLogic currency, String englishPrefixText, String englishSuffixText, String arabicPrefixText, String arabicSuffixText)
        {
            Number = number;
            Currency = currency;
    ...
    public class CurrencyInfoLogic
    {
        #region Constructors

        public CurrencyInfoLogic(Currency currency)
        {
            switch (currency)
            {
                case Currency.Egypt:
                    CurrencyID = (int)Currency.Egypt;
                    CurrencyCode = "EGP";
                ...
                case Currency.SaudiArabia:
                    CurrencyID = (int)Currency.SaudiArabia;
                    CurrencyCode = "SAR";
                    IsCurrencyNameFeminine = false;
                ...
                case Currency.Tunisia:
                    CurrencyID = (int)Currency.Tunisia;
                    CurrencyCode = "TND";
                    IsCurrencyNameFeminine = false;
                ...
                case Currency.Normal:
                    CurrencyID = (int)Currency.Normal;
                    CurrencyCode = "";
                    IsCurrencyNameFeminine = false;
                    EnglishCurrencyName = "";
